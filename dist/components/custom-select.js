"use strict";
const EMPTY_VALUE_TEXT = 'Выберите...';
class CustomSelect extends HTMLElement {
    ...
    updateOptions() {
        ...
        if (this.type == 'normal' && !options.some((opt) => opt.selected == true))
            options[0].selected = true; // Активировать первую опцию, если все остальные неактивны
    ...
    updateValue(type) {
        let selectedText = EMPTY_VALUE_TEXT;
        if (type == 'checkbox') {
